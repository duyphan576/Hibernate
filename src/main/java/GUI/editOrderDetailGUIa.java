 ...
 * @author Clock
 */
public class editOrderDetailGUIa extends javax.swing.JFrame {

    /**
     * Creates new form editOrderDetailGUIa
     */
    ...
    public editOrderDetailGUIa() {
        initComponents();
    }

    public editOrderDetailGUIa(int data) {
        initComponents();
        comboxproduct();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editOrderDetailGUIa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editOrderDetailGUIa().setVisible(true);
            }
        });
    }
